...
public class DebugWithArguments extends AnAction {
    ...
    public void actionPerformed(AnActionEvent e) {
        ...
        if(prev == null) {
            ...
            apconfig.setBeforeRunTasks(new List<BeforeRunTask>() {
                @Override
                public int size() {
                    return 0;
                }
                ...
                @Override
                public Iterator<BeforeRunTask> iterator() {
                    return null;
                }
                ...
                @Override
                public boolean add(BeforeRunTask beforeRunTask) {
                    return false;
                }
                ...
                @Override
                public boolean addAll(Collection<? extends BeforeRunTask> c) {
                    return false;
                }

                @Override
                public boolean addAll(int index, Collection<? extends BeforeRunTask> c) {
                    return false;
                }
                ...
                @Override
                public BeforeRunTask get(int index) {
                    return null;
                }

                @Override
                public BeforeRunTask set(int index, BeforeRunTask element) {
                    return null;
                }

                @Override
                public void add(int index, BeforeRunTask element) {

                }

                @Override
                public BeforeRunTask remove(int index) {
                    return null;
                }
                ...
                @Override
                public ListIterator<BeforeRunTask> listIterator() {
                    return null;
                }

                @Override
                public ListIterator<BeforeRunTask> listIterator(int index) {
                    return null;
                }

                @Override
                public List<BeforeRunTask> subList(int fromIndex, int toIndex) {
                    return null;
                }
            }); //Sets it to not build before run.
